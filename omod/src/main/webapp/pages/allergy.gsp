                        ...
                        <li>
                            ...
                            <% if (allergen.id == otherNonCodedConcept.id) { %>
                                <% if(typeName == 'DRUG') { %>
                                    ...
                                    <coded-or-free-text-answer id="${typeName}otherCodedAllergen" concept-classes="8d490dfc-c2cc-11de-8d13-0010c6dffd0f" ng-model="otherCodedAllergen" ng-focus="otherFieldFocus()" />
                                <% } else {%>
